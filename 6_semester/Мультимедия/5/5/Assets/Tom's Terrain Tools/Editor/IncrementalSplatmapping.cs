    ...
    public class IncrementalSplatmapping : EditorWindow
    {
        ...
        void FixFormat(Texture2D texture)
        {
            ...
            if (texture.format != TextureFormat.RGB24 || !textureImporter.isReadable)
            {
                ...
                //textureImporter.textureFormat = TextureImporterFormat.RGB24; // deprecated
                //textureImporter.textureCompression = TextureImporterCompression.CompressedHQ;
                // TODO https://forum.unity.com/threads/textureimporter-textureformat-is-obsolete-how-to-set-textures-format-to-rgba32.1489510/#post-9286696
        ...
        void AddTexture(Texture2D Texture, int TileSize)
        {
            ...
            newLayers[oldLayers.Length].diffuseTexture = Texture;
